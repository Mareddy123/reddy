package com.adobe.aem.guides.reddy.core.servlets;
...
import com.adobe.aem.guides.reddy.core.models.UserModel;
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
		...
		try {
			...
			Resource resource = resourceResolver
					.getResource("/content/reddy/us/en/jcr:content/root/container/container/userdemo");
